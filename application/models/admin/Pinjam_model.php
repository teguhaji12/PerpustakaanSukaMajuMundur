...
class Pinjam_model extends CI_Model {
  ...
  {
    $this->db->join('kelas', 'kelas.kelas_id = pinjam.id_kelas', 'left');
  ...
  {
    $this->db->join('buku', 'buku.buku_id = pinjam.id_buku', 'left');
    $this->db->join('kelas', 'kelas.kelas_id = pinjam.id_kelas', 'left');
    return $this->db->get_where('pinjam', ['pinjam.pinjam_id'=>$id]);
  }
  ...
  {
    $this->db->update('pinjam', $data, ['pinjam_id'=>$id]);
    return $this->db->affected_rows();
  }

  public function delete($id)
  {
    $this->db->delete('pinjam', ['pinjam_id'=>$id]);
    return $this->db->affected_rows();
  }
